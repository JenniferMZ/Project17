...
#define DATA   6        // connecto to pin 14 on the 74HC595
#define LATCH  8        // connecto to pin 12 on the 74HC595
#define CLOCK 10        // connecto to pin 11 on the 74HC595
...
void getAnswer()
{
  ...
  {
    //    do nothing until something comes in the serial buffer
  }
...
void checkAnswer()
{
  ...
  answer = 0;
  delay (10000);              // give the player time to review their answer
}
